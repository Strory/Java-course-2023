...
public class PaintSettings {
    ...
    public static final int COORDINATE_ENX_Y = 9;
    public static final int CELL_WIDTH_SIZE = 4;
    public static final int CELL_HEIGHT_SIZE = 2;
    public static final char EMPTY_SYMBOL = ' ';
    public static final char WALL_SYMBOL = '█';
    public static final char POINT_SYMBOL = '?';
}
